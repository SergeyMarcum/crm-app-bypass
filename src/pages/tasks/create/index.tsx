      ...
      <Box sx={{ p: 3 }}>
        <Grid container spacing={4}>
          ...
          <Grid size={{ xs: 12, md: 8 }}>
            <Stack spacing={2}>
              <Typography variant="h4">Создание задания</Typography>
              <Stepper
              ...
              >
                ...
                <Step>
                  ...
                  <CustomStepContent>
                    <Stack spacing={3}>
                      <Typography variant="h6">Параметры проверки</Typography>
                      <Stack spacing={1}>
                            ...
                            <FormControlLabel
                              ...
                              control={
                                <Checkbox
                                  onChange={(e) => {
                                    if (e.target.checked) {
                                      setCheckParams([...checkParams, param]);
                ...
                <Step>
                  ...
                  >
                    <Typography variant="overline">Отчет по заданию</Typography>
                  </StepLabel>
                  <CustomStepContent>
                    <Card elevation={1}>
                      <CardContent>
